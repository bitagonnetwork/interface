...
const sttaddr = "0xa3f4a5e5411db7d6630aa531d7645c72cfdda41a";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xa3f4a5e5411db7d6630aa531d7645c72cfdda41a";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+7 Bitagon sent to your wallet.',
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xa3f4a5e5411db7d6630aa531d7645c72cfdda41a',
                    'symbol': 'Bitagon',
                    'decimals': '18',
